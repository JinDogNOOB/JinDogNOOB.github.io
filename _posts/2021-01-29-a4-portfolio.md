...
> 안녕하세요
> 군에 있을때 흥미로 만들었던 업무일지관리 배치파일이 같은 소대에서 잘 쓰이는 것을 보고
>
> 개발에 성취감을 느껴서 이후 개발자를 목표로 공부했습니다.
>
> 2018.11 정보보호병으로서의 군생활을 마치고 소프트웨어 바로 개발공부를 시작했습니다
>
> 가장 기초 언어를 배워야겠다고 생각해서 C와 C++ 입문서를 구매해 학습하였습니다.
>
> 이후 제 첫 프로젝트였던 "실전 웹 해킹" 과목 팀프로젝트에서 웹 백엔드 개발, 모의해킹 을 담당했습니다.
>
> 처음이라 어떻게 해야할지 몰랐던 차에 인터넷에서 많은 자료를 찾아서 진행했었습니다
>
> 스프링은 무엇이고 MVC는 무엇인지 많은 자료를 귀갓길 버스에서 검색해서 보던 기억이 많이 남습니다
>
> 이때 외국 자료를 많이 접하면서 영어를 어떻게 학습해야하는지 알게되었습니다.
>
> 개발 팀원 3명이서 한달간 정말 밤새가면서 만들어서 좋은 결과를 보았습니다
>
...
* [Node.js/express] - 첫번째 프로젝트 Unbeil에서 사용한 프레임워크입니다. 이때 js로 협업을 진행해서 타입체크에 너무 힘이 들었습니다.
* [JPA/hibernate] - MyBatis xml 파일에 시간이 많이 걸려서 jpa hibernate 책을 구매해 공부해서 사용하고있습니다.
* [QueryDSL] - 복잡한 쿼리를 jpql로 직접쓰는 것을 대체하기 위해 사용한 라이브러리입니다. 
* [MyBatis] - 2년간 스프링부트 프로젝트를 할때 사용했던 프레임워크입니다. 견고하지만 시간이 많이 걸려 최근에는 hibernate를 사용하고있습니다.
...
* [Material-ui] - 부족한 디자인 실력을 보충하기위해 주로 사용한 ui라이브러리입니다.
##### 모바일
* [Android/Java] - 이더리움 기반 결제시스템을 모바일로 구축할때 사용했습니다.
##### 언어
...
* [ts] - 옛날 Unbeil프로젝트에서 js를 이용해 협업했을때 느꼈던 불편함을 해결하기 위해서 사용하고있습니다.
...
##### OS & 개발 환경 & 기타
* [Ubuntu] - 연구실에서 했던 프로젝트 두개 다 Ubuntu위에 톰캣에 올렸기 때문에 조금 익숙해진 OS입니다.
...
* [TDD] - 개발중 생기는 다양한 오류를 미리 예방하기 위해서 테스트코드를 먼저 짜는식으로 개발을 하였더니, 개발기간단축에 도움이 되었습니다.
* [Docker/Docker-Compose] - 빌드, 서버세팅, 배포 등의 일을 쉽게하기 위해서 학습하였습니다.
---
...
> 저는 이때 졸업 준비와 취업 준비 때문에 시간이 넉넉치 않았기 때문에 임시 프로젝트 리더로써 진행했습니다.
> 요구사항 관련 미팅, 분석, ppt 프로토타입 제작, 형상관리 Github도입, I18n 자동번역 툴 지원을 하였습니다.
> 
> 프로젝트 세부 개발쪽에는 참여를 하지 않았지만
> 실제 미술계 인사와 만들려고 하는 시스템에 대해서 토의하고 의견을 들을 수 있는 좋은 경험이었습니다.
> 가장 뿌듯했고 기억에 남는 것은 이 프로젝트에 형상관리를 위한 Github를 도입한 것입니다.
...
> 개발기간 (2021-01 / 10일)
>
> JPA Hibernate, SpringTest를 학습하고 예제코드를 만들기 위해서 만든 웹프로젝트입니다.
>
> 상당히 짧은 기간에 개발을 진행했습니다.
> 테스트를 활용해서 사전에 에러를 잡을 수 있어서 개발 기간이 상당히 단축될 수 있었습니다.
> 새로 배운 Hibernate와 QueryDSL를 사용했습니다.
...
> 
> 앞으로 IOT기기가 기본이 되고 그 수가 많이지는 시대가 왔을때 이 업데이트를 담당해야하는 중앙서버의 부담을 어떻게 하면 줄일 수 있을까?
> 를 고민하다가 탈중앙 업데이트 서비스를 IPFS, Ethereum을 이용해 만들면 좋겠다고 생각해서 개발, 발표했습니다.
